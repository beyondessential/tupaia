...
PACKAGES="report-server pdf-export-server admin-panel-server central-server entity-server lesmis lesmis-server meditrak-app-server psss psss-server web-config-server web-frontend"
