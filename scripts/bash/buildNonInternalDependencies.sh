...
PACKAGES="report-server admin-panel-server central-server data-table-server entity-server lesmis lesmis-server meditrak-app-server psss psss-server web-config-server web-frontend"
