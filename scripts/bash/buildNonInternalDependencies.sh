...
PACKAGES="report-server admin-panel-server central-server entity-server lesmis lesmis-server meditrak-app-server pdf-export-server psss psss-server web-config-server web-frontend"
