...
if [ -z ${package_path} ]; then
  echo "types ui-components" "ui-chart-components"  "ui-map-components" "utils" "tsutils" "access-policy" "admin-panel" "aggregator" "api-client" "auth" "database" "data-api" "dhis-api" "data-lake-api" "expression-parser" "indicators" "weather-api" "kobo-api" "superset-api" "data-broker" "server-boilerplate"
  exit 0
fi
