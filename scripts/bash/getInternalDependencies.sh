...
if [ -z ${package_path} ]; then
  echo "ui-components" "utils" "access-policy" "admin-panel" "aggregator" "api-client" "auth" "database" "data-api" "data-broker" "dhis-api" "expression-parser" "indicators" "weather-api" "server-boilerplate" "kobo-api"
  exit 0
fi
