...
export const extractFilterClauseFromQuery = (
  queryFilter?: string,
...
export const extractFilterClauseFromObject = (
...
export const extractEntityFilterFromQuery = (allowedCountries: string[], queryFilter?: string) => {
  ...
  const filterClauses = extractFilterClauseFromQuery(queryFilter);
...
export const extractEntityFilterFromObject = (
  ...
  const filterClauses = extractFilterClauseFromObject(queryObject);
  return extractEntityFilter(allowedCountries, filterClauses);
};
