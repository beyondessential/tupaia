...
import { BES_ADMIN_PERMISSION_GROUP, VIZ_BUILDER_USER_PERMISSION_GROUP } from '../constants';
...
const isVizBuilderUser = (policy: Record<string, string[]>) => {
...
export class UserRoute extends Route {
  public async buildResponse() {
    ...
    return {
      ...camelcaseKeys(user),
      isBESAdmin: isBESAdmin(user.accessPolicy),
      isVizBuilderUser: isVizBuilderUser(user.accessPolicy),
    };
  }
}
