 ...
 */
export const hasVizBuilderAccessToEntityForVisualisation = async (
  accessPolicy,
  models,
  entity,
  permissionGroup,
  ...
  if (entity.isProject()) {
    ...
    return (
      accessPolicy.allowsAll(countryCodes, permissionGroup) &&
      accessPolicy.allowsAll(countryCodes, VIZ_BUILDER_PERMISSION_GROUP)
    );
  }

  return (
    accessPolicy.allows(entity.country_code, permissionGroup) &&
    accessPolicy.allows(entity.country_code, VIZ_BUILDER_PERMISSION_GROUP)
  );
};
