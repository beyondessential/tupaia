...
describe('aggregateEvents()', () => {
  ...
  describe('REPLACE_ENTITY_ANSWER_WITH_ENTITY_NAME', () => {
    const aggregationConfig = {
      questionCodes: ['ELEMENT_1'],
      answerTranslation: {
        ELEMENT_1: {
          ZZ6QeE2WcDe1: 'entity_name_1',
          ZZ6QeE2WcDe2: 'entity_name_2',
          ZZ6QeE2WcDe3: 'entity_name_3',
          ZZ6QeE2WcDe4: 'entity_name_4',
          ZZ6QeE2WcDe5: 'entity_name_5',
          ZZ6QeE2WcDe6: 'entity_name_6',
        },
      },
    };

    it('replaces answer sets from entity id to entity name correctly', () => {
      const expectedResponse = [
        {
          dataValues: { ELEMENT_1: 'entity_name_1', ELEMENT_2: 'Text 1' },
          event: 'ZZ6QeE2WcDe1',
          eventDate: '2019-02-06 10:18:00.0',
          orgUnitName: 'Org Unit 1',
          orgUnit: 'Org_Unit_1',
        ...
        {
          dataValues: { ELEMENT_1: 'entity_name_2', ELEMENT_2: 'Text 2' },
          event: 'ZZ6QeE2WcDe2',
          eventDate: '2020-02-06 10:18:00.0',
          orgUnitName: 'Org Unit 1',
          orgUnit: 'Org_Unit_1',
        ...
        {
          dataValues: { ELEMENT_1: 'entity_name_3', ELEMENT_2: 'Text 3' },
          event: 'ZZ6QeE2WcDe3',
          eventDate: '2020-03-06 10:18:00.0',
          orgUnitName: 'Org Unit 2',
          orgUnit: 'Org_Unit_2',
        ...
        {
          dataValues: { ELEMENT_1: 'entity_name_4', ELEMENT_2: 'Text 4' },
          event: 'ZZ6QeE2WcDe4',
          eventDate: '2020-04-06 10:18:00.0',
          orgUnitName: 'Org Unit 3',
          orgUnit: 'Org_Unit_3',
        ...
        {
          dataValues: { ELEMENT_1: 'entity_name_5', ELEMENT_2: 'Text 5' },
          event: 'ZZ6QeE2WcDe5',
          eventDate: '2020-05-06 10:18:00.0',
          orgUnitName: 'Org Unit 4',
          orgUnit: 'Org_Unit_4',
        ...
        {
          dataValues: { ELEMENT_1: 'entity_name_6', ELEMENT_2: 'Text 6' },
          event: 'ZZ6QeE2WcDe6',
          eventDate: '2020-06-06 10:18:00.0',
          orgUnitName: 'Org Unit 1',
          orgUnit: 'Org_Unit_1',
      ...
      expect(
        aggregateEvents(
          EVENTS,
          AGGREGATION_TYPES.REPLACE_ENTITY_ANSWER_WITH_ENTITY_NAME,
          aggregationConfig,
        ),
      ).toStrictEqual(expectedResponse);
    });
