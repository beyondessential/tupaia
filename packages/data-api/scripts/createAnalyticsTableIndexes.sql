...
begin
  ...
  tStartTime := clock_timestamp();
  CREATE INDEX IF NOT EXISTS analytics_data_element_entity_survey_event_date_idx ON public.analytics(data_element_code, entity_code, survey_code, event_id, date desc);
