...
export const EVENT_ANALYTICS_WITH_DATA_VALUES: DhisEventAnalytics = {
  headers: [
...
export const EVENT_ANALYTICS_NO_DATA_VALUES: DhisEventAnalytics = {
  headers: [
    { name: 'psi', column: 'Event', valueType: 'TEXT' },
    { name: 'eventdate', column: 'Event date', valueType: 'DATE' },
    { name: 'ouname', column: 'Organisation unit name', valueType: 'TEXT' },
...
export const EVENT_ANALYTICS_EMPTY_ROWS: DhisEventAnalytics = {
  headers: [
    { name: 'psi', column: 'Event', valueType: 'TEXT' },
    { name: 'eventdate', column: 'Event date', valueType: 'DATE' },
    { name: 'ouname', column: 'Organisation unit name', valueType: 'TEXT' },
