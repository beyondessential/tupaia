...
describe('groupResults', () => {
  describe('groupAnalyticsByPeriod', () => {
    it('should return an empty object for no analytics', () => {
      expect(groupAnalyticsByPeriod()).to.deep.equal({});
      expect(groupAnalyticsByPeriod([])).to.deep.equal({});
    });
    ...
    it('should group analytics by year', () => {
      ...
      expect(groupAnalyticsByPeriod([y2017_a, y2017_b, y2018], YEAR)).to.deep.equal({
    ...
    it('should group analytics by month', () => {
      ...
      expect(groupAnalyticsByPeriod([m201701_a, m201701_b, m201712, m201801], MONTH)).to.deep.equal(
        {
    ...
    it('should group analytics by iso week', () => {
      ...
      expect(groupAnalyticsByPeriod([w2017W1_a, w2017W1_b, w2017W2, w2018W1], WEEK)).to.deep.equal({
  ...
  describe('groupEventsByPeriod()', () => {
    it('should return an empty object for no events', () => {
      expect(groupEventsByPeriod()).to.deep.equal({});
      expect(groupEventsByPeriod([])).to.deep.equal({});
    });
    ...
    it('should group events by year', () => {
      ...
      expect(groupEventsByPeriod([y2017_a, y2017_b, y2018], YEAR)).to.deep.equal({
        2017: [y2017_a, y2017_b],
        2018: [y2018],
      });
    });
    ...
    it('should group events by month', () => {
      ...
      expect(groupEventsByPeriod([m201701_a, m201701_b, m201712, m201801], MONTH)).to.deep.equal({
        201701: [m201701_a, m201701_b],
        201712: [m201712],
        201801: [m201801],
      });
    ...
    it('should group events by iso week', () => {
      ...
      expect(groupEventsByPeriod([w2017W1_a, w2017W1_b, w2017W2, w2018W1], WEEK)).to.deep.equal({
        '2017W01': [w2017W1_a, w2017W1_b],
        '2017W02': [w2017W2],
        '2018W01': [w2018W1],
      });
  ...
  describe('groupEventsByOrgUnit()', () => {
    it('should return an empty object for no events', () => {
      expect(groupEventsByOrgUnit()).to.deep.equal({});
      expect(groupEventsByOrgUnit([])).to.deep.equal({});
    });
    ...
    it('should group events by org unit', () => {
      ...
      expect(groupEventsByOrgUnit([nukunuku1, kolonga, nukunuku2])).to.deep.equal({
