...
export const SYNC_CLIENT_OUTDATED_ERROR_CODE = 'ERR_CLIENT_OUTDATED';
export const SYNC_CLIENT_VERSION_HEADER_MISSING_ERROR_CODE = 'ERR_CLIENT_VERSION_HEADER_MISSING';
