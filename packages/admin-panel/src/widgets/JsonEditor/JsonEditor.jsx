 ...
 * @property {Function} [onInvalidChange] - Set a callback function
 * triggered when json in the JSONEditor changes to an invalid state.
 * Will only be triggered on changes made by the user.
    ...
    if (this.props.onChange) {
      try {
        ...
        if (this.props.onInvalidChange) {
          ...
          this.props.onInvalidChange(error);
        }
      }
    }
  }
