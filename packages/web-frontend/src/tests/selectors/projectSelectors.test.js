    ...
    describe('functionality', () => {
      describe('selectProjectByCode', () => {
        it('can select a project', () => {
          expect(selectProjectByCode(state, 'PROJECT_1')).toEqual(state.project.projects[0]);
        });
      ...
      describe('selectIsProject', () => {
        it('can select a project which exists', () => {
          expect(selectIsProject(state, 'PROJECT_1')).toEqual(true);
        });
      ...
      describe('selectAdjustedProjectBounds', () => {
        it('can select a project which exists', () => {
          expect(selectAdjustedProjectBounds(state, 'PROJECT_1')).toEqual(
            state.project.projects[0].bounds,
          );
        });
        it('can select a project which exists', () => {
