...
export class LesmisSessionType extends DatabaseType {
  id: string;
  ...
  constructor(model: LesmisSessionModel, fieldValues: SessionFields) {
...
export class LesmisSessionModel extends DatabaseModel {
