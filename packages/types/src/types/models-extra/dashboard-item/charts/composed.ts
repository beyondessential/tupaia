...
export interface ComposedChartConfigObject extends ChartConfigObject, LineChartChartConfig {
 ...
 */
export interface ComposedChartConfig extends Omit<CartesianChartConfig, 'chartConfig'> {
