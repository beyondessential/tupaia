        ...
        <Box mb={3}>
          ...
          <List>
            <ListItem component="li">
              ...
              ທີ່ສາມາດແບ່ງປັນກັບໂຮງຮຽນອື່ນພາຍໃນກຸ່ມໂຮງຮຽນ. ບັນດາມາດຕະຖານທີ່ຕ້ອງການໆປັບປຸງ ->
              ບູລິມະສິດສຳລັບການປັບປຸງ ຄວນລວມຢູ່ໃນແຜນ ພັດທະນາໂຮງຮຽນ.
            </ListItem>
            <ListItem component="li">
              ຂະບວນການ ສ້າງແຜນພັດທະນາໂຮງຮຽນ ໂດຍອີງໃສ່ມາດຕະຖານຄຸນນະພາບຂັ້ນພື້ນຖານ ແມ່ນນຳໃຊ້ລະບົບ ICT,
              ໝາຍຄວາມວ່າມັນສົ່ງເສີມການນຳ ໃຊ້ແບບສອບຖາມອອນລາຍ ເພື່ອສະໜັບສະໜູນໂຮງຮຽນໃນການປະເມີນຕົນເອງ
              ແລະ ສ້າງແຜນພັດທະນາ.
            </ListItem>
          </List>
          <Typography gutterBottom>
            ...
            ໝາຍທີ່ດີໃນການສະໜັບສະໜູນໃຫ້ແກ່ໂຮງຮຽນ (ເບິ່ງປະເພດສະໜັບສະໜູນໂຮງຮຽນ ຂ້າງລຸ່ມນີ້).
          </Typography>
        </Box>
        <Box mb={3}>
          <Typography variant="h2" gutterBottom>
