...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  self.addEventListener('periodicsync', (event) => {
    ...
    if (event.tag === 'data-sync') {
      console.log('[Service Worker] Running periodic sync for: data-sync');
