...
const StyledLink = styled.a`
  ...
  /* This is the recommended way of adding the watermark
...
export const MapWatermark = (props: AnchorHTMLAttributes<HTMLAnchorElement>) => {
  ...
  return (
    <Wrapper>
      ...
      <InfoWrapper>
        <InfoButton onClick={() => setExpanded(true)} aria-label="Open attribution">
          <InfoIcon />
        </InfoButton>
        {expanded && (
          <AttributionsWrapper>
