...
export class Response extends RealmObject {
  toJson() {
    return {
      ...
      entities_upserted: this.entitiesUpserted.map(entity => entity.toJson()),
...
Response.schema = {
  ...
  properties: {
    ...
    dataTime: { type: 'string', default: new Date().toISOString() },
    surveyId: 'string',
    userId: 'string',
    answers: { type: 'list', objectType: 'Answer' },
    entitiesUpserted: { type: 'list', objectType: 'Entity' },
