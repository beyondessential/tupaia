...
export class ArithmeticConfigCellBuilder extends KeyValueCellBuilder {
  ...
  /**
   * (excel) answerDisplayText: SchFF00CalcTotal / SchFF00CalcTotalObtainable = $result
   * Question ids will be replaced by question codes
   * @param {*} text
   * @param {*} codes
   */
  async translateAnswerDisplayText(models, text, codes) {
