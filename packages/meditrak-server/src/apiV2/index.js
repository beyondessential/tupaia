...
apiV2.get('/dataGroups/:recordId?', useRouteHandler(BESAdminGETHandler));
...
apiV2.put('/dataElements/:recordId', useRouteHandler(BESAdminEditHandler));
apiV2.put('/dataGroups/:recordId', useRouteHandler(BESAdminEditHandler));
...
apiV2.delete('/dataElements/:recordId', useRouteHandler(BESAdminDeleteHandler));
apiV2.delete('/dataGroups/:recordId', useRouteHandler(BESAdminDeleteHandler));
