 ...
 */
export const findAnswersBySurveyResponse = async (
  models,
  criteria,
  options = { sort: [] },
  queryMethod = 'find',
) => {
  if (!criteria.survey_response_id) {
    return models.answer[queryMethod](criteria, options);
  }
  const findOnlyOptions =
    queryMethod === 'find'
      ...
      : {};
  return models.database[queryMethod](TYPES.SURVEY_RESPONSE, criteria, {
    ...findOnlyOptions,
    multiJoin: [
      {
