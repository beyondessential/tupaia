export const getHierarchyWithFields = (hierarchyCode, fields) => {
...
export const getHierarchiesWithFields = (hierarchyCodes, fields) => {
...
export const getEntityWithFields = (entityCode, fields) => {
...
export const getEntitiesWithFields = (entityCodes, fields) => {
  const allCodes = ENTITIES.map(e => e.code);
