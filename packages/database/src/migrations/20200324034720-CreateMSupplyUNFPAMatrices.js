...
exports.up = async function (db) {
  await db.runSql(`
    ...
    VALUES (
        ...
        "rows": [
          {
            ...
            "rows": [
              ...
              {
                "category": "Provision of safe abortion services and or the management of incomplete abortion and miscarriage",
                "rows": [
                  "Misoprostol 200mcg tablet",
      ...
      ',
      '{"name": "Priority Life Saving Medicines for Women and Children", "type": "matrix", "placeholder": "/static/media/PEHSMatrixPlaceholder.png"}'
    );
  `);

  return db.runSql(`
      UPDATE "dashboardGroup"
      SET "dashboardReports" = '{UNFPA_Priority_Medicines}' || "dashboardReports"
