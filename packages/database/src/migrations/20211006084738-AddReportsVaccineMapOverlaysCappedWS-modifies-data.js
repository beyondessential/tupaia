    ...
    children: [
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 1 (District)',
      ...
      },
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 2 (District)',
      ...
      },
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 1 (Village)',
        dataElements: ['COVIDVac4', 'most_recent_WS_population'],
        sortOrder: 1,
      },
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 2 (Village)',
        dataElements: ['COVIDVac8', 'most_recent_WS_population'],
        sortOrder: 3,
      },
    ],
