  ...
  transform: [
    {
      transform: 'select',
      "'name'":
        "translate($row.dataElement, { ner_district_pe_t: 'Primary', ner_district_pe_f: 'Primary', ner_district_pe_m: 'Primary', ner_district_lse_t: 'Lower Secondary', ner_district_lse_f: 'Lower Secondary', ner_district_lse_m: 'Lower Secondary', ner_district_use_t: 'Upper Secondary', ner_district_use_f: 'Upper Secondary', ner_district_use_m: 'Upper Secondary' })",
      '...': '*',
    },
    ...
    {
      transform: 'select',
      "'Male'": 'sum([$row.ner_district_pe_m, $row.ner_district_lse_m, $row.ner_district_use_m])',
      "'Female'": 'sum([$row.ner_district_pe_f, $row.ner_district_lse_f, $row.ner_district_use_f])',
      "'Total'": 'sum([$row.ner_district_pe_t, $row.ner_district_lse_t, $row.ner_district_use_t])',
      '...': ['name'],
    },
    {
      transform: 'select',
...
const FRONT_END_CONFIG = {
  name: 'Net Enrolment Rate - NER (by level of education and gender, GPI)',
  type: 'chart',
  chartType: 'composed',
