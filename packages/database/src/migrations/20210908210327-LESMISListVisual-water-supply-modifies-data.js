...
const REPORT_CONFIG = {
  ...
  transform: [
    ...
    {
      transform: 'select',
      where: 'exists($row.amenity_water_supply)',
      "'code'": "'WaterSupply'",
      "'label'": "'Water supply'",
      "'statistic'": '$row.amenity_water_supply',
      "'sort_order'": '0',
    },
    {
      transform: 'select',
      where: 'exists($row.amenity_water_allyear)',
      "'code'": "'WaterAllYear'",
      "'label'": "'Water all year round'",
      "'statistic'": '$row.amenity_water_allyear',
      "'sort_order'": '1',
    },
    {
      transform: 'select',
      where: 'exists($row.amenity_water_drinking)',
      "'code'": "'DrinkingWater'",
      "'label'": "'Clean drinking water'",
      "'statistic'": '$row.amenity_water_drinking',
      "'sort_order'": '2',
    },
    {
      transform: 'sort',
