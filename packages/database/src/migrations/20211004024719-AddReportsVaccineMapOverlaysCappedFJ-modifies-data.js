...
const MAP_OVERLAYS = [
  {
    ...
    children: [
      {
        reportCode: 'FJ_COVID_TRACKING_Dose_1_SubDistrict_Percentage_Vaccinated_Capped',
        outdatedOverlayId: 'FJ_COVID_TRACKING_Dose_1_SubDistrict_Percentage_Vaccinated',
        name: 'REPORT % of Population Vaccinated COVID-19 Dose 1 (Sub-Division)',
        dataElements: ['COVIDVac4', 'most_recent_FJ_population'],
        sortOrder: 3,
      },
      {
        reportCode: `FJ_COVID_TRACKING_Dose_1_District_Percentage_Vaccinated_Capped`,
        outdatedOverlayId: 'FJ_COVID_TRACKING_Dose_1_District_Percentage_Vaccinated',
        name: 'REPORT % of Population Vaccinated COVID-19 Dose 1 (Division)',
        dataElements: ['COVIDVac4', 'most_recent_FJ_population'],
        sortOrder: 4,
      },
      {
        reportCode: `FJ_COVID_TRACKING_Dose_2_SubDistrict_Percentage_Vaccinated_Capped`,
        outdatedOverlayId: 'FJ_COVID_TRACKING_Dose_2_SubDistrict_Percentage_Vaccinated',
        name: 'REPORT % of Population Vaccinated COVID-19 Dose 2 (Sub-Division)',
        dataElements: ['COVIDVac8', 'most_recent_FJ_population'],
        sortOrder: 8,
      },
      {
        reportCode: `FJ_COVID_TRACKING_Dose_2_District_Percentage_Vaccinated_Capped`,
        outdatedOverlayId: 'FJ_COVID_TRACKING_Dose_2_District_Percentage_Vaccinated',
        name: 'REPORT % of Population Vaccinated COVID-19 Dose 2 (Division)',
        dataElements: ['COVIDVac8', 'most_recent_FJ_population'],
        sortOrder: 9,
      },
    ],
