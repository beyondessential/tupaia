    ...
    children: [
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 1 (Sub-Division)',
      ...
      },
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 1 (Division)',
        dataElements: ['COVIDVac4', 'most_recent_FJ_population'],
        sortOrder: 4,
      },
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 2 (Sub-Division)',
      ...
      },
      {
        ...
        name: '% of Population Vaccinated COVID-19 Dose 2 (Division)',
        dataElements: ['COVIDVac8', 'most_recent_FJ_population'],
        sortOrder: 9,
      },
    ],
