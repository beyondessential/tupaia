      ...
      "dataBuilderConfig" = '
        {
          ...
          "rows": [
            ...
            },
            {
              "category": "NCDs",
              "rows": [
                "Long-acting bronchodilators for patients who remain symptomatic despite treatment with short-acting bronchodilators (for improvement of lung function)", "Prevention of cervical cancer through screening services",
                "Referral for screening and evaluation for laser treatment for diabetic retinopathy", "Smoking cessation support for COPD patients is available", "Prevention of breast cancer through screening services",
                ...
                "Individual advice about modification of diet, maintenance of a healthy body weight and regular physical activity", "Metformin as initial drug for all patients",
                "Angiotensin converting enzyme inhibitor for persistent albuminuria",
                "Cardiac rehabilitation (supervision of treatment and follow-up)", "Assess cardiovascular risk",
                "Identify presenting features of cancer and refer to next level for confirmation of diagnosis (from NCD PEN)",
                "Aspirin, antihypertensive (low dose thiazide, angiotensin-converting enzyme inhibitor) and statins", "NCD outreach clinics/services are regularly provided", "Medical palliative care for cancer",
                "Prevention of onset and progression of neuropathy: Optimal glycemic control", "Type 1 diabetes patients provided with meters and strips",
                ...
                "Promotion of early healing of diabetic foot ulcers and reduction in risk of amputation through off-loading techniques", "National guidelines for management of diabetes", "Daily insulin injections",
                "Regular administration of antibiotics to prevent streptococcal pharyngitis and recurrent acute rheumatic fever",
                "The population served have access to key messages related to NCDs", "Aspirin for acute myocardial infarction",
                "Oral hypoglycemic agents for type 2 diabetes, if glycemic targets are not achieved with modification of diet, maintenance of a healthy body weight and regular physical activity", "Inhaled corticosteroids for improvement of lung function",
                ...
                "Diabetic retinopathy prevention through glycemic and blood pressure control", "Care of acute stroke and rehabilitation",
                "Prevention of foot complications through examination and monitoring:", "Anti-hypertensives for people with blood pressure ≥160/100", "Health promotion about healthy lifestyle and prevention",
                "Other classes of anti-hyperglycemic agents added to metformin if glycemic targets are not met",
                "Relief of symptoms: Oral or inhaled short-acting ß2 agonists", "Chronic kidney disease prevention in diabetes",
                ...
                "Counselling and education on risk factors, signs and symptoms of cancer", "Cancer treatment services available",
            ...
            },
            {
              ...
              "rows": [
                "Special care for RHD, NCD and people with special needs (Disabilities)", "School preventives to all pre-and primary schools", "Oral assessments of RHD patients", "Referral of any oral lesions for specialist assessment",
                ...
                "Curative work: consultation, assessment and treatments provided (save the tooth-fillings or dental extraction), pain relief and referral", "Oral assessment of pre-natal/pregnant mothers",
                "Fabricate other dental prosthesis, removal orthodontic appliance, mouthguard, space maintainers", "Provision of dentures", "School preventives to secondary school and NCD patients"
              ]
            }
          ],
          "columns": "$orgUnit"
