...
const NEW_MEASURE_BUILDER_CONFIG = {
  ...
  measureBuilderConfig: {
    ...
    dataElementToString: {
      SchCVD010a: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Water system (num papa)',
      },
      SchCVD010b: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Water borehole',
      },
      SchCVD010c: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Wells',
      },
      SchCVD010d: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Water connection from community gravity-fed water system',
      },
      SchCVD010f: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Water from pond',
      },
      SchCVD010e: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Water from river',
      },
      SchCVD010g: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Water reservoir',
      },
      SchCVD010i: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Rainwater harvesting',
      },
      SchCVD010h: {
        valueOfInterest: 'Yes',
        stringToConvert: 'Other water source',
      },
      BCD29_event: {
        valueOfInterest: 'No',
        stringToConvert: 'No',
