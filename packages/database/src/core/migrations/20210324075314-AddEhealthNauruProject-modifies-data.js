...
import { codeToId, insertObject, generateId } from '../../core/utilities';
...
const countryCodes = ['NR'];
const projectCode = 'ehealth_nauru';
const projectName = 'Nauru eHealth';
const projectDescription = 'Improving health outcomes in Nauru through digital health systems';
const dashboardGroupName = 'COVID-19 Nauru';
const userGroups = ['Donor'];

const imageUrl =
  'https://tupaia.s3-ap-southeast-2.amazonaws.com/uploads/ehealth_nauru_background.png';
const logoUrl = 'https://tupaia.s3-ap-southeast-2.amazonaws.com/uploads/ehealth_nauru_logo.png';

const getCountryDashboardGroupCode = (countryCode, userGroup) =>
  `${countryCode}_EHEALTH_NAURU_Country_${userGroup.split(' ').join('_')}`;
