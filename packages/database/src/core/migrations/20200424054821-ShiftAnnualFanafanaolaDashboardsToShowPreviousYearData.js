...
const PERIOD_GRANULARITY = 'one_year_at_a_time';
const PERIOD_TO_MOVE = -1;
const PERIOD_FORMAT = 'years';
...
exports.up = async function (db) {
  ...
  await db.runSql(`
    ...
    WHERE
      "id" IN (${ANNUAL_FANAFANAOLA_DASH_REPORTS_SQL});
  `);
};
...
// Select Statement to select all the Fanafanaola dashboard reports that have period_granularity = 'one_year_at_a_time'
const ANNUAL_FANAFANAOLA_DASH_REPORTS_SQL = `SELECT DISTINCT "dashboardReport".id
