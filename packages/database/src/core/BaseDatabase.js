...
export class BaseDatabase {
  ...
  /**
   * @template ReturnT
   * @param {<ReturnT = unknown, DatabaseT extends BaseDatabase = BaseDatabase>(db: DatabaseT) => Promise<ReturnT>} _wrappedFunction
   * @param {Knex.TransactionConfig} [_transactionConfig]
  ...
  /**
   * @template ReturnT
   * @param {<ReturnT = unknown, DatabaseT extends BaseDatabase = BaseDatabase>(db: DatabaseT) => Promise<ReturnT>} wrappedFunction
