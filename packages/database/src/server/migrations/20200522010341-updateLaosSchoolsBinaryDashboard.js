...
import { insertObject, arrayToDbString } from '../../core/utilities';
...
const SCHOOL_BINARY_DASHBOARD = {
  ...
  dataBuilder: 'booleanValueByDataElements',
  dataBuilderConfig: {
    dataElementToString: DATA_ELEMENTS,
...
const NEW_DASHBOARD_GROUP_CODES = ['LA_Laos_Schools_School_Laos_Schools_User'];
const OLD_DASHBOARD_GROUP_CODES = [
...
exports.up = async function (db) {
  await db.runSql(`
    ...
    WHERE "code" IN (${arrayToDbString(OLD_DASHBOARD_GROUP_CODES)});
