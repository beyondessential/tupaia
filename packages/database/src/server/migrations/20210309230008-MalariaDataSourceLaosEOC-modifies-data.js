...
import { insertObject, generateId, deleteObject } from '../../core/utilities';
...
const DATA_GROUP = {
  id: generateId(),
  code: 'Malaria_Case_Reporting',
  type: 'dataGroup',
  service_type: 'dhis',
  config: { dhisId: 'VTiOn7wKC4Q', isDataRegional: false },
};
...
const DATA_ELEMENTS = [
  ...
  {
    id: generateId(),
    code: 'Total_Malaria_Deaths',
    type: 'dataElement',
    service_type: 'dhis',
    config: { dhisId: 'thVoQkSNwC8', isDataRegional: false, dhisDataType: 'ProgramIndicator' },
  },
];
