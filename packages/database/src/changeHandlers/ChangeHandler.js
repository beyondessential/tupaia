...
export class ChangeHandler {
  /**
   * A map of change pushers by record type. Each pusher can return a list of changes that will be
   * queued and scheduled for handling at a later stage, when changes stop coming through.
   *
   * If no pusher is defined for the record type, then the `changeDetails` generated by the db
