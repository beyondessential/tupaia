...
def create_instance_from_image(code, stage, instance_type, iam_role_arn=None, user_data=None, subdomains_via_dns=None, subdomains_via_gateway=None, volume_size=None, security_group_id=None):
    ...
    instance_object = create_instance(code, instance_type, stage, iam_role_arn=iam_role_arn, image_id=image_id, user_data=user_data, subdomains_via_dns=subdomains_via_dns, subdomains_via_gateway=subdomains_via_gateway, volume_size=volume_size, security_group_id=security_group_id)

    return instance_object

def create_tupaia_instance_from_image(server_deployment_code, branch, instance_type, setup_gateway=True, security_group_id=None):
