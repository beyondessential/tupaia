...
def create_tupaia_instance_from_image(
    ...
    tupaia_subdomains = ['','admin','admin-api','api','config','export','mobile','psss','report-api','psss-api','entity-api','lesmis-api','lesmis', 'meditrak-api', 'data-table-api', 'tupaia-web-api', 'datatrak-web-api', 'datatrak'] if setup_gateway else None
