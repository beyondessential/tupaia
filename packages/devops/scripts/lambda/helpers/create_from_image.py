...
def create_server_instance_from_image(
    ...
    tupaia_subdomains = ['','admin','admin-api','api','config','psss','central-api','report-api',
        'psss-api','entity-api','lesmis-api','lesmis','meditrak-api','data-table-api',
        'tupaia-web-api','tupaia-web','datatrak-web-api','datatrak'
    ]
