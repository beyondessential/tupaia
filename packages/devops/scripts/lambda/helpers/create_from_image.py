...
def create_instance_from_image(code, stage, instance_type, iam_role_arn=None, user_data=None, subdomains_via_dns=None, subdomains_via_gateway=None):
...
def create_tupaia_instance_from_image(server_deployment_code, branch, instance_type):
    ...
    create_instance_from_image(server_deployment_code, branch, instance_type, iam_role_arn=tupaia_server_iam_role_arn, user_data=startup_script, subdomains_via_dns=['ssh'], subdomains_via_gateway=tupaia_subdomains)
