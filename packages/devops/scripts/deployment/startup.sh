...
# Fetch and deploy the latest for each repository based on the stage, including injecting environment
# variables from parameter store into the .env file
${HOME_DIRECTORY}/tupaia-devops/scripts/deployment/deployLatestRepositories.sh

# Set nginx config and start the service running
${HOME_DIRECTORY}/tupaia-devops/scripts/deployment/configureNginx.sh
