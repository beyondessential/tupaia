...
PACKAGES=("meditrak-server" "web-config-server" "psss-server" "lesmis-server" "viz-builder-server" "report-server" "entity-server" "web-frontend" "admin-panel" "psss" "lesmis")
