...
DB_URL=$CI_TEST_DB_URL DB_PORT=$DB_PORT DB_NAME=$CI_TEST_DB_NAME DB_USER=$CI_TEST_DB_USER DB_PASSWORD=$CI_TEST_DB_PASSWORD DB_PG_USER=$DB_PG_USER DB_PG_PASSWORD=$DB_PG_PASSWORD DB_MV_USER=$DB_MV_USER DB_MV_PASSWORD=$DB_MV_PASSWORD yarn workspace @tupaia/data-api patch-analytics-table up
