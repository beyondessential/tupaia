...
INVALID_CHARS=('/' '\' '.' '&' '?' '_')
SUBDOMAIN_SUFFIXES=(admin admin-api aggregation api config db export lesmis lesmis-api mobile psss psss-api report report-api ssh entity entity-api central-api meditrak-api data-table-api tonga-aggregation www tupaia-web-api tupaia-web-rewrite datatrak-web-api datatrak)
