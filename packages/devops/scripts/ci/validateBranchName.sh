...
INVALID_CHARS=('/' '\' '.' '&' '?')
RESERVED_NAMES=(e2e)
SUBDOMAIN_SUFFIXES=(admin admin-panel-api aggregation api config export lesmis lesmis-api mobile psss psss-api report report-api entity entity-api tonga-aggregation www)
