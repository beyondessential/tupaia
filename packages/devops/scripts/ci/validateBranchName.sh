...
INVALID_CHARS=('/' '\' '.' '&' '?' '_')
SUBDOMAIN_SUFFIXES=(admin admin-api aggregation api config db export lesmis lesmis-api mobile pdf-export-api psss psss-api report report-api ssh entity entity-api meditrak-api tonga-aggregation www)
