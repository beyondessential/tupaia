...
if [ -f "/common/deployment_exists" ]; then
    ...
    REACT_APP_DEPLOYMENT_NAME=${CI_BRANCH} CI=false yarn workspace @tupaia/${PACKAGE} build # set CI to false to ignore warnings https://github.com/facebook/create-react-app/issues/3657
