...
import { convertDateRangeToPeriods } from '/utils/convertDateRangeToPeriods';
...
describe('convertDateRangeToPeriods', () => {
  it('should convert a date range within a single month', () => {
    ...
    expect(periods).to.have.ordered.members([
      '20180205',
      '20180206',
      '20180207',
      '20180208',
  ...
  it('should convert a single day into a period', () => {
    ...
    const periods = convertDateRangeToPeriods(startDate, endDate);
    expect(periods).to.have.ordered.members(['20161029']);
  });
  ...
  it('should handle February 29 in a leap year', () => {
    ...
    const periods = convertDateRangeToPeriods(startDate, endDate);
    expect(periods).to.have.ordered.members(['20160227', '20160228', '20160229', '20160301']);
  });
  ...
  it('should convert first of month to entire month', () => {
    ...
    const periods = convertDateRangeToPeriods(startDate, endDate);
    expect(periods).to.have.ordered.members(['201602', '201603', '20160401']);
  });
  ...
  it('should handle last day of month', () => {
    ...
    const periods = convertDateRangeToPeriods(startDate, endDate);
    expect(periods).to.have.ordered.members(['201607', '201608']);
  });
});
