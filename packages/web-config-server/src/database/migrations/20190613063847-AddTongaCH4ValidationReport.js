...
const REPORT_ID = 'TO_CH_Validation_CH_4';
const BASE_REPORT_NAME = 'Annual DMII/HTN Patient Risk Factor Data';
    ...
    VALUES
      (
        ...
        '{
          ...
          "stripFromColumnCategoryNames": ".*- ",
          "rowDataElementGroupSets": ["CH4_Rows_1_Risk_Factor", "CH4_Rows_2_CVD_Risk"],
          "columnDataElementGroupSets": ["CH4_Columns_Number"]
        }',
        '{
