...
exports.up = function(db) {
  return db.runSql(`
    ...
    VALUES
      (
        ...
        '{
          ...
          "columnDataElementGroupSets": ["HP_04_Gender_Counts"]
        }',
        '{
          "name": "Monthly National Quitline",
          "type": "chart",
          "chartType": "matrix",
    ...
    UPDATE
      "dashboardGroup"
    SET
      "dashboardReports" = "dashboardReports" || '{ TO_HPU_Validation_HP_04 }'
    WHERE
...
exports.down = function(db) {
  return db.runSql(`
    DELETE FROM "dashboardReport" WHERE "id" = 'TO_HPU_Validation_HP_04';

    UPDATE
      "dashboardGroup"
    SET
      "dashboardReports" = array_remove("dashboardReports", 'TO_HPU_Validation_HP_04')
    WHERE
      "code" IN ('TO_Health_Promotion_Unit_Validation', 'DL_Health_Promotion_Unit_Validation');
  `);
};
