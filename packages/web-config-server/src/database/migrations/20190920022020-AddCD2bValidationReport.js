...
const STRIP_FROM_COLUMN_NAMES = 'CD2b ';
const PROGRAM_CODE = 'Tonga_CD2b';
const REPORT_COLUMNS = getReportColumnsInRange(21, 31);
const REPORT_ID = 'TO_CD_Validation_CD2b';
const REPORT_NAME = 'STIs - Syphilis';
