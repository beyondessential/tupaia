...
import { Route, MeditrakDeviceRecord } from '@tupaia/server-boilerplate';
...
export class AuthRoute extends Route<AuthRequest> {
  private async updateMeditrakDevice(meditrakDevice: MeditrakDeviceRecord, refreshToken: string) {
