...
export default defineConfig(({ command, mode }) => {
  ...
  const baseConfig = {
    ...
    resolve: {
      ...
      dedupe: ['@material-ui/core', 'react', 'react-dom', 'styled-components', 'react-router', 'react-router-dom'], // deduplicate these packages to avoid duplicate copies of them in the bundle, which might happen and cause errors with ui component packages
      alias: {
